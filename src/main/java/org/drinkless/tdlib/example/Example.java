...
public final class Example {
    ...
    public static volatile boolean quiting = false;
    ...
    public static final NavigableSet<OrderedChat> chatList = new TreeSet<OrderedChat>();
    public static boolean haveFullChatList = false;
    ...
    public static void getChatList(final int limit) {
        synchronized (chatList) {
